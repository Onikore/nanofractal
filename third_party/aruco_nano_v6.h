...
std::vector<Marker>  MarkerDetector::_detect(const cv::Mat &img, unsigned int maxAttemptsPerCandidate, Dict dict, DetectorParams params){
    ...
    else if(dict==DICT_4X4_50)   Dict_codes=aruco_std_dicts::DICT_4X4_50();
    else if(dict==DICT_4X4_100)  Dict_codes=aruco_std_dicts::DICT_4X4_100();
    else if(dict==DICT_4X4_250)  Dict_codes=aruco_std_dicts::DICT_4X4_250();
    else if(dict==DICT_4X4_1000) Dict_codes=aruco_std_dicts::DICT_4X4_1000();
    else if(dict==DICT_5X5_50)   Dict_codes=aruco_std_dicts::DICT_5X5_50();
    else if(dict==DICT_5X5_100)  Dict_codes=aruco_std_dicts::DICT_5X5_100();
    else if(dict==DICT_5X5_250)  Dict_codes=aruco_std_dicts::DICT_5X5_250();
    else if(dict==DICT_5X5_1000) Dict_codes=aruco_std_dicts::DICT_5X5_1000();
    else if(dict==DICT_6X6_50)   Dict_codes=aruco_std_dicts::DICT_6X6_50();
    else if(dict==DICT_6X6_100)  Dict_codes=aruco_std_dicts::DICT_6X6_100();
    else if(dict==DICT_6X6_250)  Dict_codes=aruco_std_dicts::DICT_6X6_250();
    else if(dict==DICT_6X6_1000) Dict_codes=aruco_std_dicts::DICT_6X6_1000();
    else if(dict==DICT_7X7_50)   Dict_codes=aruco_std_dicts::DICT_7X7_50();
    else if(dict==DICT_7X7_100)  Dict_codes=aruco_std_dicts::DICT_7X7_100();
    else if(dict==DICT_7X7_250)  Dict_codes=aruco_std_dicts::DICT_7X7_250();
    else if(dict==DICT_7X7_1000) Dict_codes=aruco_std_dicts::DICT_7X7_1000();
    else return {};
