...
// (Apache-2.0) for marker *rendering* in tests/tools only. Detection still uses
// the header's own private copy of these tables. Generated by extracting the
// two Dict_codes initializers from the header (do not hand-edit the numbers).
